...
%Visualización de los Datos del Excel
figure(1);
subplot(3,1,1)
plot(t,Wm); grid;
...
%Método de chen
%Elección de 3 puntos equisdistantes:
inicio_W = 703;
delta_W = 2;
...
%Visualización de los puntos en el 'Zoom'
figure(3);
subplot(2,1,1)
...
%con la FT GENERAL obtenemos los PARÁMETROS del motor:
ki = 1/(G_W.num{1}(3))
km = ki
R = Ei/max(Iobt)
J = G_I.num{1}(2)
