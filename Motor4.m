...
subplot(4,1,1)
plot(t, wr); grid;
title('Motor'); xlabel('Tiempo [s]'); ylabel('Velocidad angular [Rad/s]');
subplot(4,1,2)
plot(t, ia); grid;
title('Armadura'); xlabel('Tiempo [s]'); ylabel('Corriente [A]');
subplot(4,1,3)
plot(t, theta);
title('Motor');xlabel('Tiempo [s]'); ylabel('Angulo [Rad]');
subplot(4,1,4)
